...
if (!empty($_GET['download'] == 'doc')) {
    ...
    header("content-disposition: attachment;filename=" . date('d-m-Y') . "_nota_pembelian.doc");
}
if (!empty($_GET['download'] == 'xls')) {
    header("Content-Type: application/force-download");
    header("Cache-Control: no-cache, must-revalidate");
    header("Expires: 0");
    header("content-disposition: attachment;filename=" . date('d-m-Y') . "_nota_pembelian.xls");
}
?>
<!DOCTYPE html>
<html>
        ...
        <page size="A4">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h4 style="color: black;"> <b>NOTA PEMBELIAN -- <span style="color: red;"><?= $pembelian[0]->tgl_beli; ?></span> </b> </h4>
                    <br>
                    <div class="row">
