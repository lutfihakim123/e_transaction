        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h2 class="ml-4">Edit Pembelian</h2>
                    <form action="<?= base_url('pembelian/edit_pembelian'); ?>" method="post">
                        <div class="col-6">
                            <input type="text" value="<?= $pembelian[0]->id_pembelian; ?>" name="id_pembelian" hidden>
                            <input type="text" hidden value="<?= $pembelian[0]->id_supplier; ?>" class="form-control" name="id_supplier" readonly>
                            <table class="table">
                                <tr>
                                    <td>Supplier</td>
                                    <td>
                                        <input type="text" value="<?= $pembelian[0]->nama; ?>" class="form-control" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Barang</td>
                                    <td><input type="text" value="<?= $pembelian[0]->barang; ?>" name="barang" class="form-control" readonly></td>
                                </tr>
                                <tr>
                                    <td>Quantitas</td>
                                    <td><input type="number" value="<?= $pembelian[0]->quantitas; ?>" name="quantitas" class="form-control" readonly></td>
                                </tr>
                                <tr>
                                    <td>Harga Satuan</td>
                                    <td><input type="number" value="<?= $pembelian[0]->satuan; ?>" name="satuan" class="form-control" readonly></td>
                                </tr>
                                <tr>
                                    <td>Tanggal Update</td>
                                    <td><input type="date" value="<?= $pembelian[0]->tgl_beli; ?>" name="tgl_beli" class="form-control" name="password"></td>
                                </tr>
                                <tr>
                                    <td>Total Bayar</td>
                                    <td><input type="number" name="total_bayar" value="<?= $pembelian[0]->total_bayar; ?>" class="form-control"></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>
                                        <input type="submit" class="btn btn-primary float-right" value="Update Pembelian">
                                    </td>
                                </tr>
                            </table>
                        </div>
