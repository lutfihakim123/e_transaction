        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h2 class="ml-4">Tambah Pembelian</h2>
                    <form action="<?= base_url('pembelian/add_pembelian'); ?>" method="post">
                        <div class="col-6">
                            <table class="table">
                                <tr>
                                    <td>Supplier</td>
                                    <td>
                                        <select class="custom-select" required name="id_supplier">
                                ...
                                <tr>
                                    <td>Tanggal Beli</td>
                                    <td><input type="date" name="tgl_beli" autocomplete="off" class="form-control" name="password"></td>
                                </tr>
                                <tr>
                                    <td>Quantitas</td>
                                ...
                                <tr>
                                    <td></td>
                                    <td>
                                        <input type="submit" class="btn btn-primary float-right" value=" Tambah Pembelian">
                                    </td>
                                </tr>
                            </table>
                        </div>
