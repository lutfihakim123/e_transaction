        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <form action="<?= base_url('pembelian'); ?>" method="post" class="form-inline float-left">
                            <h4 class="ml-3">Data Pembelian </h4>
                            <input type="text" name="keyword_pembelian" class="form form-control ml-2" autocomplete="off">
                            <input type="submit" name="pembelian" class="btn btn-primary ml-2" value="Cari Data" autocomplete="off">
                        ...
                        <div class="col-12">
                            <table class="table mt-2">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $p->status; ?></td>
                                        <td>
                                            <a href="<?php echo base_url('pembelian/view_edit_pembelian/' . $p->id_pembelian); ?>" class="badge badge-success"> <i class="fa fa-edit"></i> Edit</a>
                                            <a href="<?php echo base_url('pembelian/delete_pembelian/' . $p->id_pembelian); ?>" class="badge badge-danger"> <i class="fas fa-trash-alt"></i> Delete</a>
                                            <a href="<?php echo base_url('pembelian/nota_pembelian/' . $p->id_pembelian); ?>" class="badge badge-info"> <i class="fas fa-print"></i> Print</a>
                                        </td>
                                    </tr>
                                <?php
                                }
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <a href="<?= base_url('pembelian/view_add_pembelian'); ?>" class="btn btn-primary mb-5"> <i class="fas fa-plus"></i> Tambah Data</a>
                                </div>
                                <div class="col-6">
