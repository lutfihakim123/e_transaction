        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h2 class="ml-4">Tambah Admin</h2>
                    <form action="<?= base_url('c_admin/add_admin'); ?>" method="post">
                        <div class="col-6">
                            <table class="table">
                                <tr>
                                    <td>Username</td>
                                ...
                                <tr>
                                    <td>Email</td>
                                    <td><input type="text" autocomplete="off" class="form-control" required name="email"></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>
                                        <input type="submit" class="btn btn-primary float-right" value=" Tambah Admin">
                                    </td>
                                </tr>
                            </table>
                        </div>
