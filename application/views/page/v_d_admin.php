                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <table class="table mt-2">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $r->email; ?></td>
                                        <td>
                                            <a href="<?php echo base_url('c_admin/view_edit_admin/' . $r->id_admin); ?>" class="btn btn-success"> <i class="fa fa-edit"></i> Edit</a>
                                            <a href="<?php echo base_url('c_admin/delete_admin/' . $r->id_admin); ?>" class="btn btn-danger"> <i class="fas fa-trash-alt"></i> Delete</a>
                                        </td>
                                    </tr>
                                <?php
                                }
                            ...
                            <a href="<?= base_url('c_admin/view_add_admin'); ?>" class="btn btn-primary"> <i class="fas fa-user-plus"></i> Tambah Admin</a>
                        </div>
                    </div>
                </div>
                <!-- /.container-fluid -->
