        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h5 class="ml-4"> <b>Cetak Pembelian Berdasarkan Barang, Supplier Dan Tgl Beli</b> </h5> <br>
                    <div class="col-md-10">
                        <form action="<?= base_url('pembelian/cetak_pembelian'); ?>" method="post" class="form-inline ml-2 float-left">
                            ...
                            <h5 class="ml-3">Supplier </h5>
                            <select class="custom-select ml-1" name="id_supplier">
                            ...
                            <h5 class="ml-3">Tgl Beli</h5>
                            <input type="date" name="tgl_beli" class="form form-control ml-3" autocomplete="off">
                            <input type="submit" name="submit" class="btn btn-info ml-2" value="Cetak Data" autocomplete="off">
                        </form>
                    </div>
                    <br>
                    <br>
                    <br>
                    <h5 class="ml-4"> <b>Cetak Pembelian Berdasarkan Range Tgl Beli dan Barang</b> </h5> <br>
                    <form action="<?= base_url('pembelian/cetak_pembelian'); ?>" method="post" class="form-inline ml-2 float-left">
                        <h5 class="ml-3">Barang </h5>
                        <select class="custom-select ml-1" name="barang">
                            <option value="" selected>Pilih Barang</option>
                    ...
                    <br>
                    <br>
                    <h5 class="ml-4"> <b>Cetak Penjualan Berdasarkan Supplier Range Tgl Jual dan Barang</b> </h5> <br>
                    <form action="<?= base_url('pembelian/cetak_pembelian'); ?>" method="post" class="form-inline ml-2 float-left">
                        <h5 class="ml-3">Barang </h5>
                        <select class="custom-select ml-1" name="barang">
                            <option value="" selected>Pilih Barang</option>
                        ...
                        <h5 class="ml-3">Tgl End </h5>
                        <input type="date" name="end" class="form form-control ml-3" autocomplete="off">
                        <input type="submit" name="supplier_range" class="btn btn-info ml-2" value="Cetak Data" autocomplete="off">
                    </form>
                </div>
                <!-- /.container-fluid -->
