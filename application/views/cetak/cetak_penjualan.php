...
if (!empty($_GET['download'] == 'doc')) {
    ...
    header("content-disposition: attachment;filename=" . date('d-m-Y') . "_laporan_penjualan.doc");
}
if (!empty($_GET['download'] == 'xls')) {
    header("Content-Type: application/force-download");
    header("Cache-Control: no-cache, must-revalidate");
    header("Expires: 0");
    header("content-disposition: attachment;filename=" . date('d-m-Y') . "_laporan_penjualan.xls");
}
?>
<?php
        ...
        <page size="A4">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-9">
                            <h4 style="color: black;"> <b>LAPORAN DATA PENJUALAN</b> </h4>
                        </div>
                        <div class="col-2">
