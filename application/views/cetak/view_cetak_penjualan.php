        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h5 class="ml-4"> <b>Cetak Penjualan Berdasarkan Bandar Dan Tgl Jual</b> </h5> <br>
                    <div class="col-md-9">
                        <form action="<?= base_url('penjualan/cetak_penjualan'); ?>" method="post" class="form-inline ml-2 float-left">
                            <h5 class="ml-3">Barang </h5>
                            <select class="custom-select ml-1" name="barang">
                                <option value="" selected>Pilih Barang</option>
                                <option value="jamur tiram">Jamur Tiram</option>
                                <option value="jamur kuping">Jamur Kuping</option>
                            </select>
                            <h5 class="ml-3">Bandar</h5>
                            <select class="custom-select ml-1" name="id_bandar">
                                <option value="" selected>Pilih bandar</option>
                                <?php foreach ($bandar as $b) {
                                ?>
                                    <option value="<?= $b->id_bandar; ?>"><?= $b->nama; ?></option>
                                <?php
                                }
                                ?>
                            </select>
                            <h5 class="ml-3">Tgl Jual</h5>
                            <input type="date" name="tgl_jual" class="form form-control ml-3" autocomplete="off">
                            <input type="submit" name="submit" class="btn btn-info ml-2" value="Cetak Data">
                        </form>
                    </div>
                    <br>
                    <br>
                    <br>
                    <h5 class="ml-4"> <b>Cetak Penjualan Berdasarkan Range Tgl Jual dan barang</b> </h5> <br>
                    <form action="<?= base_url('penjualan/cetak_penjualan'); ?>" method="post" class="form-inline ml-2 float-left">
                        <h5 class="ml-3">Barang </h5>
                        <select class="custom-select ml-1" name="barang">
                            <option value="" selected>Pilih Barang</option>
                    ...
                    <br>
                    <br>
                    <h5 class="ml-4"> <b>Cetak Penjualan Berdasarkan Bandar Range Tgl Jual dan barang</b> </h5> <br>
                    <form action="<?= base_url('penjualan/cetak_penjualan'); ?>" method="post" class="form-inline ml-2 float-left">
                        <h5 class="ml-3">Barang </h5>
                        <select class="custom-select ml-1" name="barang">
                            <option value="" selected>Pilih Barang</option>
                        ...
                        <h5 class="ml-3">Tgl End </h5>
                        <input type="date" name="end" class="form form-control ml-3" autocomplete="off">
                        <input type="submit" name="bandar_range" class="btn btn-info ml-2" value="Cetak Data" autocomplete="off">
                    </form>
                </div>
                <!-- /.container-fluid -->
