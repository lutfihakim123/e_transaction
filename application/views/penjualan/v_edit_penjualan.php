        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h2 class="ml-4">Edit Penjualan</h2>
                    <form action="<?= base_url('penjualan/edit_penjualan'); ?>" method="post">
                        <div class="col-6">
                            <input type="text" value="<?= $penjualan[0]->id_penjualan; ?>" name="id_penjualan" hidden>
                            <input type="text" hidden value="<?= $penjualan[0]->id_bandar; ?>" class="form-control" name="id_bandar" readonly>
                            <table class="table">
                                <tr>
                                    <td>Supplier</td>
                                    <td>
                                        <input type="text" value="<?= $penjualan[0]->nama; ?>" class="form-control" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Barang</td>
                                    <td><input type="text" name="barang" value="<?= $penjualan[0]->barang; ?>" class="form-control" readonly></td>
                                </tr>
                                <tr>
                                    <td>Quantitas</td>
                                    <td><input type="number" value="<?= $penjualan[0]->quantitas; ?>" name="quantitas" class="form-control" readonly></td>
                                </tr>
                                <tr>
                                    <td>Harga Satuan</td>
                                    <td><input type="number" value="<?= $penjualan[0]->satuan; ?>" name="satuan" class="form-control" readonly></td>
                                </tr>
                                <tr>
                                    <td>Tanggal Update</td>
                                    <td><input type="date" value="<?= $penjualan[0]->tgl_jual; ?>" name="tgl_jual" class="form-control" name="password"></td>
                                </tr>
                                <tr>
                                    <td>Total Bayar</td>
                                    <td><input type="number" name="total_bayar" value="<?= $penjualan[0]->total_bayar; ?>" class="form-control" name="alamat"></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>
                                        <input type="submit" class="btn btn-primary float-right" value="Update Penjualan">
                                    </td>
                                </tr>
                            </table>
                        </div>
