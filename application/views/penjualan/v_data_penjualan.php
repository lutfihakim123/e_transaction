        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <form action="<?= base_url('penjualan'); ?>" method="post" class="form-inline float-left">
                            <h4 class="ml-3">Data Penjualan </h4>
                            <input type="text" name="keyword_penjualan" class="form form-control ml-2" autocomplete="off">
                            <input type="submit" name="penjualan" class="btn btn-primary ml-2" value="Cari Data" autocomplete="off">
                        ...
                        <div class="col-12">
                            <table class="table mt-2">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $p->status; ?></td>
                                        <td>
                                            <a href="<?php echo base_url('penjualan/view_edit_penjualan/' . $p->id_penjualan); ?>" class="badge badge-success"> <i class="fa fa-edit"></i> Edit</a>
                                            <a href="<?php echo base_url('penjualan/delete_penjualan/' . $p->id_penjualan); ?>" class="badge badge-danger"> <i class="fas fa-trash-alt"></i> Delete</a>
                                            <a href="<?php echo base_url('penjualan/nota_penjualan/' . $p->id_penjualan); ?>" class="badge badge-info"> <i class="fas fa-print"></i> Print</a>
                                        </td>
                                    </tr>
                                <?php
                                }
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <a href="<?= base_url('penjualan/view_add_penjualan'); ?>" class="btn btn-primary mb-5"> <i class="fas fa-plus"></i> Tambah Data</a>
                                </div>
                                <div class="col-6">
