        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h2 class="ml-4">Tambah Penjualan</h2>
                    <form action="<?= base_url('penjualan/add_penjualan'); ?>" method="post">
                        <div class="col-6">
                            <table class="table">
                                <tr>
                                    <td>Bandar</td>
                                    <td>
                                        <select class="custom-select" required name="id_bandar">
                                ...
                                <tr>
                                    <td>Barang</td>
                                    <td>
                                        <select class="custom-select" required name="barang">
                                ...
                                <tr>
                                    <td>Tanggal Jual</td>
                                    <td><input autocomplete="off" type="date" name="tgl_jual" class="form-control" name="password"></td>
                                </tr>
                                <tr>
                                    <td>Quantitas</td>
                                    <td><input type="number" autocomplete="off" name="quantitas" class="form-control" name="nama"></td>
                                </tr>
                                <tr>
                                    <td>Harga Satuan</td>
                                    <td><input type="number" autocomplete="off" name="satuan" class="form-control" name="no_telp"></td>
                                </tr>
                                <tr>
                                    <td>Total bayar</td>
                                    <td><input type="number" autocomplete="off" name="total_bayar" class="form-control" name="alamat"></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>
                                        <input type="submit" class="btn btn-primary float-right" value=" Tambah Penjualan">
                                    </td>
                                </tr>
                            </table>
                        </div>
