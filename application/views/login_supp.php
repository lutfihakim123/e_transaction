                            ...
                            <div class="col-lg-10">
                                <div class="p-5">
                                    <div class="text-center">
                                        <img src="<?= base_url('assets'); ?>/img/supp_login.png" class="img-fluid" style="width: 250px;">
                                    </div>
                                    <div class="text-center">
                                        <br>
                                        <h1 class="h4 text-gray-900 mb-4"> <b>Login Supplier</b></h1>
                                        <?= $this->session->flashdata('message'); ?>
                                    </div>
                                    <form action="<?= base_url('login/aksi_login_supp'); ?>" method="POST" class="user">
