        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h5 class="ml-4"> <b>Cetak Pembelian Berdasarkan Range Tgl Beli</b> </h5> <br>
                    <form action="<?= base_url('v_supplier/cetak_pembelian'); ?>" method="post" class="form-inline ml-2 float-left">
                        ...
                        <input type="text" name="id_supplier" value="<?= $_SESSION['id_supp'];  ?>" hidden>
            ...
            <footer class="sticky-footer">
                <div class="row">
                    <div class="col-9"></div>
                    <div class="col-3">
                        <div class="card ml-5 text-dark border-primary mb-3" style="max-width: 12rem;">
                            <div class="card-header border-primary"> <i class="fas fa-pencil-alt"></i> Note</div>
                            <div class="card-body">
                                <h7 class="card-title">Your ID Supplier : <?= $_SESSION['id_supp']; ?> </h7>
                            </div>
                        </div>
                    </div>
                </div>
