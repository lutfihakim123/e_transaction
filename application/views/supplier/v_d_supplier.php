            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <a href="<?= base_url('c_supplier/cetak_supplier'); ?>" style="float: right;" class="btn btn-info mt-2"> <i class="fas fa-print"></i> Cetak Data</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <table class="table mt-2">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $r->alamat; ?></td>
                                        <td>
                                            <a href="<?php echo base_url('c_supplier/view_edit_supplier/' . $r->id_supplier); ?>" class="btn btn-success"> <i class="fa fa-edit"></i> Edit</a>
                                            <a href="<?php echo base_url('c_supplier/delete_supplier/' . $r->id_supplier); ?>" class="btn btn-danger"> <i class="fas fa-trash-alt"></i> Delete</a>
                                        </td>
                                    </tr>
                                <?php
                                }
                            ...
                            <a href="<?= base_url('c_supplier/view_add_supplier'); ?>" class="btn btn-primary"> <i class="fas fa-user-plus"></i> Tambah Supplier</a>
                        </div>
                    </div>
                </div>
                <!-- /.container-fluid -->
