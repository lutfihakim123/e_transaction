        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h2 class="ml-4">Edit Supplier</h2>
                    <form action="<?= base_url('c_supplier/edit_supplier'); ?>" method="post">
                        <div class="col-6">
                            <table class="table">
                                <input type="text" hidden name="id_supplier" value="<?= $records[0]->id_supplier; ?>">
                                <tr>
                                    <td>Username</td>
                                ...
                                <tr>
                                    <td>Password</td>
                                    <td><input type="text" class="form-control" required name="password"></td>
                                </tr>
                                <tr>
                                    <td>Nama lengkap</td>
                                ...
                                <tr>
                                    <td>Alamat</td>
                                    <td><input type="text" class="form-control" name="alamat" value="<?= $records[0]->alamat; ?>"></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>
                                        <input type="submit" class="btn btn-primary float-right" value=" Edit Supplier">
                                    </td>
                                </tr>
                            </table>
                        </div>
