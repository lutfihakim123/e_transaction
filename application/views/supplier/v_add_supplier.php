        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h2 class="ml-4">Tambah Supplier</h2>
                    <form action="<?= base_url('c_supplier/add_supplier'); ?>" method="post">
                        <div class="col-6">
                            <table class="table">
                                <tr>
                                    <td>username</td>
                                    <td><input type="text" autocomplete="off" class="form-control" required name="username"></td>
                                </tr>
                                <tr>
                                    <td>password</td>
                                    <td><input type="password" autocomplete="off" class="form-control" required name="password"></td>
                                </tr>
                                <tr>
                                    <td>Nama Lengkap</td>
                                    <td><input type="text" autocomplete="off" class="form-control" required name="nama"></td>
                                </tr>
                                <tr>
                                    <td>No Telp</td>
                                    <td><input type="text" autocomplete="off" class="form-control" required name="no_telp"></td>
                                </tr>
                                <tr>
                                    <td>alamat</td>
                                    <td><input type="text" autocomplete="off" class="form-control" required name="alamat"></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>
                                        <input type="submit" class="btn btn-primary float-right" value=" Tambah Supplier">
                                    </td>
                                </tr>
                            </table>
                        </div>
