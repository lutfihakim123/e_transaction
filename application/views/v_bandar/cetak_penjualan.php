...
if ($_SESSION['level'] != 'bandar') {
    redirect(base_url('login/login_bandar'));
}
?>
<?php
error_reporting(0);
if (!empty($_GET['download'] == 'doc')) {
    ...
    header("content-disposition: attachment;filename=" . date('d-m-Y') . "_laporan_transaksi.doc");
}
if (!empty($_GET['download'] == 'xls')) {
    header("Content-Type: application/force-download");
    header("Cache-Control: no-cache, must-revalidate");
    header("Expires: 0");
    header("content-disposition: attachment;filename=" . date('d-m-Y') . "_laporan_transaksi.xls");
}
?>
<!DOCTYPE html>
<html>
        ...
        <page size="A4">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-9">
                            <h4 style="color: black;"> <b>LAPORAN DATA TRANSAKSI</b> </h4>
                        </div>
                        <div class="col-2">
                        ...
                        <div class="col-12">
                            <table class="table" style="color: black;">
                                <tr style="background-color: whitesmoke;">
                                    <td> <small>ID Bandar</small> </td>
                                    <td> <small>Barang</small> </td>
                                    <td> <small>Tgl Jual</small> </td>
                                ...
                                ?>
                                    <tr>
                                        <td> <small><?= $p->id_bandar; ?></small> </td>
                                        <td> <small><?= $p->barang; ?></small> </td>
                                        <td> <small><?= $p->tgl_jual; ?></small> </td>
