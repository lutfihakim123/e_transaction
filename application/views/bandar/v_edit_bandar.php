        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h2 class="ml-4">Edit Bandar</h2>
                    <form action="<?= base_url('c_bandar/edit_bandar'); ?>" method="post">
                        <div class="col-6">
                            <table class="table">
                                <input type="text" hidden name="id_bandar" value="<?= $records[0]->id_bandar; ?>">
                                <tr>
                                    <td>Username</td>
                                ...
                                <tr>
                                    <td></td>
                                    <td>
                                        <input type="submit" class="btn btn-primary float-right" value=" Edit Bandar">
                                    </td>
                                </tr>
                            </table>
                        </div>
