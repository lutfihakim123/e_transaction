        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h2 class="ml-4">Tambah Bandar</h2>
                    <form action="<?= base_url('c_bandar/add_bandar'); ?>" method="post">
                        <div class="col-6">
                            <table class="table">
                                <tr>
                                    <td>Username</td>
                                ...
                                <tr>
                                    <td></td>
                                    <td>
                                        <input type="submit" class="btn btn-primary float-right" value=" Tambah Bandar">
                                    </td>
                                </tr>
                            </table>
                        </div>
