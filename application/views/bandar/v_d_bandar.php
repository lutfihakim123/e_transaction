            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <a href="<?= base_url('c_bandar/cetak_bandar'); ?>" style="float: right;" class="btn btn-info mt-2"> <i class="fas fa-print"></i> Cetak Data</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <table class="table mt-2">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $r->alamat; ?></td>
                                        <td>
                                            <a href="<?php echo base_url('c_bandar/view_edit_bandar/' . $r->id_bandar); ?>" class="btn btn-success"> <i class="fa fa-edit"></i> Edit</a>
                                            <a href="<?php echo base_url('c_bandar/delete_bandar/' . $r->id_bandar); ?>" class="btn btn-danger"> <i class="fas fa-trash-alt"></i> Delete</a>
                                        </td>
                                    </tr>
                                <?php
                                }
                            ...
                            <a href="<?= base_url('c_bandar/view_add_bandar'); ?>" class="btn btn-primary"> <i class="fas fa-user-plus"></i> Tambah Bandar</a>
                        </div>
                    </div>
                </div>
                <!-- /.container-fluid -->
